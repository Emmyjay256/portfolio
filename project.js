...
const PROJECT = {
    ...
    assets: {
        ...
        gallery: [
            { src: "hajambo1.jpg", caption: "Hajambo — App UI / Screenshots" },
            { src: "hajambo2.jpg", caption: "USSD flow — Feature phone onboarding" },
            { src: "hajambo3.jpg", caption: "Offline Nearby Mode — Mesh networking concept" }
        ]
    },
